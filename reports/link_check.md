...
identifiers and **120** formatted variants against all **24,797** artifacts,
...
**67** manifest-listed assets and **100,164,389** bytes at manifest SHA-256
...
Batch 656 local validation, 2026-09-23 UTC: the isolated release build contains
**24,724** HTML files and **24,796** total artifacts. Every internal link
resolves, and the checker inventories **50,347** unique external URLs for the
separate live check. The public-identifier audit compares **12,926** normalized
identifiers and **120** formatted variants against all **24,796** artifacts,
rejects **1,130** candidate substrings, and finds zero unexpected boundary,
aggregate, or manifest-size matches. The local release verifier matches all
**67** manifest-listed assets and **99,935,605** bytes at manifest SHA-256
...
Batch 654 local validation, 2026-09-23 UTC: the isolated release build
contains **24,717** HTML files and **24,789** total artifacts. Every internal
link resolves, and the checker inventories **50,324** unique external URLs for
the separate live check. The public-identifier audit compares **12,926**
normalized identifiers and **120** formatted variants against all **24,789**
artifacts, rejects **1,126** candidate substrings, and finds zero unexpected
boundary, aggregate, or manifest-size matches. The local release verifier
matches all **67** manifest-listed assets and **99,652,295** bytes at manifest
SHA-256
...
Batch 653 local validation, 2026-09-23 UTC: the isolated release build
contains **24,714** HTML files. Every internal link resolves, and the checker
inventories **50,317** unique external URLs for the separate live check. The
public-identifier audit compares **12,926** normalized identifiers and **120**
formatted variants against **24,786** artifacts, with zero unexpected
full-number boundary matches. The local release verifier matches all **67**
manifest-listed assets and **99,558,364** bytes at manifest SHA-256
`d1387c1412657ffe2e43c7746c3b9e2aebfaa1e30b6e468411be1ab25ccd59f7`.
Two consecutive public-data builds reproduce tree SHA-256
...
for the generated Astro data. External URLs were inventoried, not all
requested; CI and live-release verification are separate gates.

Batch 637 local validation, 2026-09-22 UTC: the isolated tracked-only build
...
matches all **67** manifest-listed assets and **98,362,523** bytes at manifest
SHA-256 `3c2ce3c66855b56003e64cfed3ded21547ff4e675f6adcbdd860bb94648ac454`.
...
normalized identifiers and **120** formatted variants against every artifact,
with zero unexpected full-number boundary matches. The local release verifier
matches all **67** manifest-listed assets and **98,292,743** bytes at manifest
SHA-256 `09b86baf7b19ad898317b0a929172baa09e4d66fa9349defe39f998a94881eaa`.
Two consecutive clean builds reproduce the same production-tree SHA-256
`9ca7eea4a5699d050c71fbf15b4e1dc939b6699577b4ca46c0491745efd68f2a`.
Unrelated untracked duplicate files in the working checkout were preserved but
excluded from the release candidate.

Batch 634 local validation, 2026-09-22 UTC: the isolated tracked-only build
contains **24,681** HTML files and **24,753** total artifacts. Every internal
link resolves, and the checker inventories **50,238** unique external URLs for
the separate live check. The public-identifier audit compares **12,926**
normalized identifiers and **120** formatted variants against every artifact,
with zero unexpected full-number boundary matches. The local release verifier
matches all **67** manifest-listed assets and **98,261,307** bytes at manifest
SHA-256 `7e1001b90f36dd0a775b8189256712633c56750c1a89c93e1e1d51fe88792bf4`.
Two consecutive clean builds reproduce the same production-tree SHA-256
`0468be59ad9d7e61a7c06b3fca6600d431aac923cbb79e3b11c5610263aabc81`.
Unrelated untracked duplicate files in the working checkout were preserved but
excluded from the release candidate.

Batch 633 local validation, 2026-09-22 UTC: the isolated tracked-only build
contains **24,681** HTML files and **24,753** total artifacts. Every internal
link resolves, and the checker inventories **50,238** unique external URLs for
the separate live check. The public-identifier audit compares **12,926**
normalized identifiers and **120** formatted variants against every artifact,
with zero unexpected full-number boundary matches. The local release verifier
matches all **67** manifest-listed assets and **98,230,826** bytes at manifest
SHA-256 `f1041c176097ee821e71a6b3904f96ba4eeb19e6512cd0731460cf26810f2a13`.
Two consecutive clean builds reproduce the same production-tree SHA-256
`3305acea947a144e5e7b86ced0ad1440d9e2cb9dc037f932d57f4030fad65e0c`.
Unrelated untracked duplicate files in the working checkout were preserved but
excluded from the release candidate.

Batch 632 local validation, 2026-09-22 UTC: the isolated tracked-only build
contains **24,681** HTML files and **24,753** total artifacts. Every internal
link resolves, and the checker inventories **50,236** unique external URLs for
the separate live check. The public-identifier audit compares **12,926**
normalized identifiers and **120** formatted variants against every artifact,
with zero unexpected full-number boundary matches. The local release verifier
matches all **67** manifest-listed assets and **98,197,781** bytes at manifest
SHA-256 `d3e019f8766a29b091b41914b76244ef71f608f6661f0fb6816587261b196701`.
Two consecutive clean builds reproduce the same production-tree SHA-256
`f7b4db300268a0d4f962d60719333e7773cc7706bfac83d24c2225d3d9a6d010`.
Unrelated untracked duplicate files in the working checkout were preserved but
excluded from the release candidate.

Batch 631 local validation, 2026-09-22 UTC: the isolated tracked-only build
contains **24,681** HTML files and **24,753** total artifacts. Every internal
link resolves, and the checker inventories **50,236** unique external URLs for
the separate live check. The public-identifier audit compares **12,926**
normalized identifiers and **120** formatted variants against every artifact,
with zero unexpected full-number boundary matches. The local release verifier
matches all **67** manifest-listed assets and **98,174,615** bytes at manifest
SHA-256 `30cccec4e88ac9b675df26026445053644c3f07a2f9b4c770c03bbc69731285a`.
Two consecutive clean builds reproduce the same production-tree SHA-256
`cd7023141eff5be4124e823f9df93af0172ac521dbd98cf16b965002db530152`.
Unrelated untracked duplicate files in the working checkout were preserved but
excluded from the release candidate.

Batch 630 local validation, 2026-09-22 UTC: the isolated tracked-only build
contains **24,681** HTML files and **24,753** total artifacts. Every internal
link resolves, and the checker inventories **50,236** unique external URLs for
the separate live check. The public-identifier audit compares **12,926**
normalized identifiers and **120** formatted variants against every artifact,
with zero unexpected full-number boundary matches. The local release verifier
matches all **67** manifest-listed assets and **98,138,968** bytes at manifest
SHA-256 `d664836bd59004478131e195dcc06e6230b0dcc501459c97153345e347e32742`.
Two consecutive clean builds reproduce the same production-tree SHA-256
`c8f97ad1daa276df103cf1cc72d88efb138a8b52be8c3df7cb2b376602b39c2b`.
Unrelated untracked duplicate files in the working checkout were preserved but
excluded from the release candidate.

Batch 615 local validation, 2026-09-21 UTC: the isolated tracked-only build
contains **24,677** HTML files and **24,749** total artifacts. Every internal
link resolves, and the checker inventories **50,226** unique external URLs for
the separate live check. The public-identifier audit compares **12,926**
normalized identifiers and **120** formatted variants against every artifact,
with zero unexpected full-number boundary matches. The local release verifier
matches all **67** manifest-listed assets and **97,806,543** bytes at manifest
SHA-256
...
seven-person oil-company workers category. An unrelated untracked duplicate
Sources route adds 25 local-only pages and is excluded from the clean release.
The checker inventoried **50,237** unique external URLs; it did not request
every target. The public-identifier audit compared **12,926** normalized
identifiers and **120** variants against **24,767** public artifacts, with zero
unexpected full-number boundary matches. The local release verifier matched
all **67** manifest-listed assets and **97,577,955** bytes at manifest SHA-256
...
seven-person oil-company workers category. An unrelated untracked duplicate
Sources route adds 25 local-only pages and is excluded from the clean release.
The checker inventoried **50,232** unique external URLs; it did not request
every target. The public-identifier audit compared **12,926** normalized
identifiers and **120** variants against **24,766** public artifacts, with zero
unexpected full-number boundary matches. The local public manifest verified
**67** assets and **97,465,498** bytes at SHA-256
`685082198e14b0083dd0dc95f31c687c15f660ff84f6f4d24a9d0f829120f63e`.
Clean CI, Pages deployment, and live exact-file verification remain separate
release checks.
...
sections. The checker inventoried **50,164** unique external URLs; it did
not request every external target. The field-aware public-identifier audit
compared 12,926 normalized identifiers and 120 variants against 24,730
public artifacts, with zero unexpected full-number boundary matches. The
local manifest matched **67** assets and **96,872,984** bytes at SHA-256
`b3fc292447ec384900825a13741fb3220a4c0bf297df9649b7df8e52ace68053`.
...
unique external URLs without visiting every target. The public-identifier
audit found zero unexpected full-number boundary matches across **24,729**
public artifacts. The local public-data manifest matched **67** assets and
**96,715,912** bytes at SHA-256
`2f4fdf88817d1b5fb5a748053b0da1e14c2724cff638909ec7e8422d34a4950f`.
Public deployment and live hash verification are tracked separately.

Batch 590 local validation, 2026-09-20 UTC: all internal links resolve
across **24,652** built HTML files, including the top oil-company category,
its dedicated route, and 25 Sources pages. The checker inventoried **50,142**
unique external URLs without visiting every target. The public-identifier
audit found zero unexpected full-number boundary matches across **24,724**
public artifacts. The local public-data manifest matched **67** assets and
**96,599,802** bytes at SHA-256
`def1df597178fd1f511497d84deb55c461c28a2f56c083d7c47c96145d65d319`.
Public deployment and live hash verification are tracked separately.

Batch 588 local validation, 2026-09-20 UTC: all internal links resolve
across **24,651** built HTML files, including the top oil-company category,
its dedicated route, and 25 Sources pages. The checker inventoried **50,140**
unique external URLs without visiting every target. The public-identifier
audit found zero unexpected full-number boundary matches across **24,723**
public artifacts. Public deployment and live hash verification are tracked
separately and are not implied by this local check.

Batch 587 local validation, 2026-09-20 UTC: all internal links resolve
across **24,651** built HTML files, including the oil-company category and
25 Sources pages. The checker inventoried **50,137** unique external URLs;
these were not all visited. The public-identifier audit found zero unexpected
full-number boundary matches across **24,723** public artifacts. The
stratified 200-profile audit passed its machine-checkable gates. Public
deployment and exact live-asset verification are tracked separately and are
not implied by this local result.

Batch 586 exact-verified public release, 2026-09-20 UTC: all internal links
...
25 Sources pages, and sixteen direct profiles to exact merge commit
`3565891fb4048d0de757f6f38d9cb8428e1fff63`; see
...
The checker inventoried **50,123** unique external URLs but did not visit
every target. The public-identifier audit found zero unexpected full-number
boundary matches across **24,719** public artifacts. The local manifest
verifier matched all **67** public assets / **96,257,044** bytes at SHA-256
...
Previous exact-verified public release: 2026-09-20 UTC, Batch 582. All internal links resolve
across 24,647 generated HTML pages, including 25 Sources-register pages.
The checker inventoried 50,121 unique external URLs without visiting every
external target. The full-identifier audit found zero unexpected boundary
matches across 24,719 public artifacts. The local and unauthenticated live
verifiers matched all 67 assets / 96,210,168 bytes at SHA-256
`c3a4b45c6cf80f72da58ff4a9f89f6fd10c2c570455b72f38d713166edbfacea`.
The live verifier also matched seven core routes, 25 Sources pages, and ten
direct profiles to merge commit
`3a2a9c0784016bed6f1e192eb4d6452eeabc777e`; see
`reports/release_batch_582.md`.

Previous exact-verified public release: 2026-09-20 UTC, Batch 581. All
...
The local checker resolved all internal links across 24,622 generated HTML
pages and inventoried 50,093 unique external URLs without claiming to have
...
`fa54cf77b5a20f91b7a67df95ecd0a1409c62e12`. Details:
...
are inventoried, not all visited. Identifier checks cover all 24,644 built
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,099
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 93,062,362 bytes at
SHA-256 `e1cc09592cabdc87e3ef52117a065cda8ab5f8a6b60525bb3dacdbdbcd5bb05a`.
Under the relative-path/content digest, the 70-file public tree is
`329d79c9adce29ba61776990820b0a256fc9051d88ac6ca7f61f516fb0dd4899`;
the 24,644-file production tree is
`f72d61b4b5fa1dcbc49f3e37b78e4b03810fe1277a8a98e5d3f4a36aeb5a078a`.
Three exact GitHub Pages-configured builds reproduce both trees. Eight bundle
sources support Robert W Davy's confirmed identity and qualified occupation
and the ranked Carlos B Dawes row's high-confidence identity and dated
...
rejected after context review. No authenticated Catalog request was used. PR
Test run 34942781371, main Test run 34943561714 and Pages run 34943561874
succeeded; the live verifier matched all 67 manifest assets, 93,015,740 bytes,
seven core routes and ten direct Batch 540 profiles at merge commit
`9bfccbb5d8aa757b696a1189b5d43f6d2d8efe1b`.
...
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,101
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,888,056 bytes at
SHA-256 `ba14dbf76dc11db6dea909a73f870f927ef91cefb5409329528516c487c58a9a`.
Under the relative-path/content digest, the 70-file public tree is
...
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,099
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,861,626 bytes at
SHA-256 `0676e403a3ffc45d52c8165f2fdc138e7bda32d3656ca7987ea0f88afce92c04`.
Under the relative-path/content digest, the 70-file public tree is
...
two confirmed identity and two qualified occupation claims without an
employer claim. All 114 Library of Congress candidates were rejected through
the durable review workflow. No authenticated Catalog request was used.
PR Test run 34928915638, main Test run 34929378545 and Pages run 34929378541
succeeded; the live verifier matched all 67 manifest assets, 92,861,626 bytes,
seven core routes and ten direct Batch 536 profiles at merge commit
`af3adc4ca850b542d458409e66e1017420bb5740`.

## Batch 535 release candidate

All internal targets resolve across 24,571 HTML pages; 49,946 external URLs
are inventoried, not all visited. Identifier checks cover all 24,643 built
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,102
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,831,424 bytes at
SHA-256 `348184d44f06d191cffe98babd1df1258c01ce4a199705f7477e338a7dd2751e`.
Under the relative-path/content digest, the 70-file public tree is
...
Three consecutive builds reproduced both trees. Three bundle sources support
one confirmed identity claim; no occupation or employer claim is created from
the undefined Army value `944`. Forty-five Library of Congress candidates
were rejected after official context review. No authenticated Catalog request
was used. PR Test run 34925100415, main Test run 34925491952 and Pages run
34925491956 succeeded; the live verifier matched all 67 manifest assets,
92,831,424 bytes, seven core routes and ten direct Batch 535 profiles at merge
commit `ae0ed517fe059eddfeee93ff1fca27f5b23bed91`.

## Batch 534 release candidate

All internal targets resolve across 24,571 HTML pages; 49,946 external URLs
are inventoried, not all visited. Identifier checks cover all 24,643 built
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,103
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,816,730 bytes at
SHA-256 `8df9e3acfb9f64d47199584e63494d64e22456602a3e705dba2edc3dd13f11b3`.
Under the relative-path/content digest, the 70-file public tree is
...
Three consecutive builds reproduced both trees. Three bundle sources support
three confirmed identity and three qualified occupation claims. Thirty-four
...
site checks passed: PR Test run 34921536919, main Test run 34921981099 and
Pages run 34921981119 succeeded; the live verifier matched all 67 manifest
assets and ten direct cohort profiles to merge commit
`b8b0e2ea9c2e7b4c7053d708207dd8c94a984452`.
...
Library of Congress candidates were rejected after official context review.
No authenticated Catalog request was used. Independent GitHub and deployed-
site checks passed: PR Test run 34918835156, main Test run 34919328724 and
Pages run 34919328709 succeeded; the live verifier matched all 67 manifest
assets and ten direct cohort profiles to merge commit
`6fb8569af3f255bcda0c3b8063cc174416449d7d`.
...
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,101
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,637,647 bytes at
SHA-256 `04ff7c5edb82b7728ce0e1070c7504cd66d7d0dc950282e35c65ed582d8bf358`.
Under the relative-path/content digest, the 70-file public tree is
...
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,103
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,591,760 bytes at
SHA-256 `10519180118be822351be0d1d3b2d93d87b39b98512b940be4f17e90b36b4ac3`.
Under the relative-path/content digest, the 70-file public tree is
...
Three consecutive Pages builds reproduced both trees. Nine bundle sources
support accepted or qualified findings; no CIA Reading Room or Library of
Congress candidate was returned. No authenticated Catalog request was used.
PR Test run 34892869139, main Test run 34893610220 and Pages run 34893609558
passed; the live verifier matched all 67 manifest assets and ten direct cohort
profiles to merge commit `d019620c99e3bfdc766b22eb791677ad524bb070`.

## Batch 528 release candidate

All internal targets resolve across 24,569 HTML pages; 49,940 external URLs
are inventoried, not all visited. Identifier checks cover all 24,641 built
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,103
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,500,770 bytes at
SHA-256 `eb713a1ac38ebaa9b9c9b78d36a25bccdcaae368f4a43f6a434f54959be4d344`.
Under the relative-path/content digest, the 70-file public tree is
`9d2bd387b940da614c7d4c0a5c36b43dd487ee1a4b67da0aa576a0e13f082951`;
the 24,641-file production tree is
`0f9f74c27aac9fef10d39a036b8b0d4e20b8e6c3632f3bbfee84f6fc273093cc`.
Three consecutive Pages builds reproduced both trees. Six bundle sources
support accepted or qualified findings; one Library of Congress namesake
candidate was rejected after official OCR-context review. No authenticated
Catalog request was used. PR Test run 34888224444, main Test run 34888921543
and Pages run 34888921596 passed; the live verifier matched all 67 manifest
assets and ten direct cohort profiles to merge commit
`6183df25f674697924bff6df106a736b183c5b77`.
...
download release assembly detected after Batch 526. PR Test run 34882800063,
main Test run 34883520025 and Pages run 34883519985 passed; the live verifier
matched all 67 manifest assets and ten direct cohort profiles to merge commit
`c1f014215bef39fe451117f910943aacb46eb3ab`.
...
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,102
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,221,715 bytes at
SHA-256 `fa58242565764511649adcd32372f9fbeb175fb2fbdf5971f95fab82c1ffaeba`.
Under the relative-path/content digest, the 70-file public tree is
...
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,102
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,203,485 bytes at
SHA-256 `ec5422224c6a43c81e2121658f0fb8fe32d26d2604dba940927c46782e612f05`.
Under the relative-path/content digest, the 70-file public tree is
...
support two identity claims and two qualified student-or-occupation claims;
seven Library of Congress candidates were rejected after official OCR-context
review. No authenticated Catalog request was used. PR Test run 34863234720,
main Test run 34863949031 and Pages run 34863948698 passed; the live verifier
matched all 67 manifest assets and ten direct cohort profiles.
...
authenticated Catalog request was used. PR Test run 34858254253, main Test run
34859041025 and Pages run 34859041152 passed; the live verifier matched all 67
manifest assets and ten direct cohort profiles.
...
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,102
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 92,122,570 bytes at
SHA-256 `31a0c59a5961f70508a6396b6def931d61a216cd16a15572cb9a7daa538bc40e`.
Under the relative-path/content digest, the 70-file public tree is
...
All internal targets resolve across 24,558 HTML pages; 49,909 external URLs
are inventoried, not all visited. Identifier checks cover all 24,630 built
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,103
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 91,767,883 bytes at
SHA-256 `1539477854d9ead37c4811635ece7dbc0ad96d8740ec408f68589c7f50df99aa`.
Under the relative-path/content digest, the 70-file public tree is
`40471f1be6b358201e9782849beb1a666d80a8a7438291e2fcf728b79d54cfec`;
the 24,630-file production tree is
`a47f6038a06b7bbf250a96e141ee9cfd35dca0696bc1b83ae6dcbaceebfdbf4c`.
A second exact public-data and Pages build reproduced both trees. Nine bundle
sources support the accepted, qualified or conflicting outcomes; two Library
of Congress candidates were rejected after full-page review. No authenticated
Catalog request was used. Independent GitHub and deployed-site checks remain
pending.
...
artifacts, 12,926 normalized identifiers, 120 formatted variants and 1,112
candidate substring coincidences, with zero unexpected boundary, aggregate or
manifest-size matches. The public manifest has 67 assets / 91,340,900 bytes at
SHA-256 `b0234ce9df72691252a79e6327747ed00815d11661f72c365b493456b813fb26`.
...
tracked Batch 426 evidence bundle. Manifest: 67 assets / 84,773,353 bytes;
SHA-256
...
Catalog request or access-control bypass was used. Independent PR Test
`33989727271`, PR 182 and Pages `33992396552` passed. Pinned verification
against `66e9b0497e1475fff8e2047652cddab14ceed441` matched all 67 assets /
84,736,826 bytes, seven core routes and ten direct cohort profiles. The
supplementary merge-triggered Test `33992396479` also passed in 42 minutes 11
seconds; see `reports/release_batch_425.md`.
...
substring coincidences with zero unexpected boundary, aggregate or manifest-
size matches. A separate scan finds zero full private identifiers in the
tracked Batch 424 evidence bundle. Manifest: 67 assets / 84,701,215 bytes;
SHA-256
...
Catalog request or access-control bypass was used. Independent GitHub Test
`33963248213`, PR 180 and Pages `33969269323` passed. Pinned verification
against `f89959540adc872924b6e3a25ce2237a94f00108` matched all 67 assets /
84,648,538 bytes, seven core routes and ten direct cohort profiles; see
...
Seven of eight Batch 391 citation targets returned HTTP 200 to the automated
GET check: both NARA OSS PDFs, the public Army-series Catalog page, both
official Army technical-documentation PDFs, the Open Road Media biography, and
the institutional copy of the contemporary OSS Middle East report. Texas A&M
OAKTrust returned HTTP 403 to the final automated request after its item page
and thesis text had already been reviewed during evidence collection. No
...
The static build contains 24,445 HTML files, including direct pages for all
23,940 active person entities, 497 public organizations, and every Batch 391
profile. Every internal link resolves. The 65 public-manifest files cover
82,317,440 bytes and passed all 130 size and SHA-256 checks in each of the
...
scan found zero nonblank NARA keys and no local secret environment file. Three
consecutive public-data exports reproduced path-and-content digest
`98d2ab3665e21b2000562567c7e5dcf935ed5fd53eaccf36e37f10a1b288a118`.
Two consecutive finalized production builds reproduced path-and-content
static-tree digest
`1e1bbe9590c9f828ed0b8aee937caef22ca192a10befd4edb355bb99ba250f24`.

Astro diagnostics report zero errors, warnings, or hints, and the six focused
Batch 391 browser scenarios pass 18 / 18 across desktop, phone, and tablet.
...
and accessibility matrix passed 1,482 / 1,482 cases in 11.2 minutes, including
all 27 axe cases.

## Batch 390 production verification

Release `ef9ccef` passed pull-request Test workflow
[33357605472](https://github.com/therealjameswilson/before-oss/actions/runs/33357605472)
and Pages workflow
[33359234262](https://github.com/therealjameswilson/before-oss/actions/runs/33359234262).
The cache-busted production audit opened seven core routes, all ten Batch 390
person profiles, and both newly linked organization pages. All 19 returned
HTTP 200 and matched the audited local HTML after development and production
canonical-host normalization.

The live manifest and all 65 listed assets matched the local release byte for
byte across 82,246,832 bytes with zero failures. The live manifest SHA-256 is
`d58e1be19c103e91e2d30407ad65ba57d801a8d4d0ba930462ba6fa2d9371ed3`.
The live statistics reported 23,978 source rows, 23,940 active people, 3,683
research attempts, 487 people with verified affiliations, 208 people with
verified employers, 3,636 archival-review assessments, 2,874 published claims,
and 2,533 public sources. Public download line counts were 23,941 for personnel
CSV, 23,940 for personnel JSONL, 496 for organizations CSV, 1,437 for
affiliations CSV, and 2,534 for sources CSV. Because every fetched manifest
asset and normalized HTML route matched its audited local counterpart, the
production release inherits the zero-match private-identifier result.
...
## Batch 386 production deployment

Release `d18dc29e85dc8b92cc9f15ba79d7e41389fc14c1` passed the pull-request Test
workflow
[33349259226](https://github.com/therealjameswilson/before-oss/actions/runs/33349259226)
and Pages workflow
[33350692000](https://github.com/therealjameswilson/before-oss/actions/runs/33350692000).
The clean runner repeated the Python suite, complete 24,439-page internal-link
check, 1,410-case browser and accessibility matrix, source-PDF reconstruction,
and private-identifier audit before merge.

The cache-busted production audit opened seven core routes and all ten Batch 386
person profiles. All 17 returned HTTP 200. The live manifest and all 65 listed
assets matched the audited local release byte for byte, covering 81,954,554
bytes with zero failures. The live manifest SHA-256 is
`93b3ba5a66699f7ae4cb7266ad8b21e8c17217ae5303ec5db253a814a064a17e`.
The live statistics report 23,978 source rows, 23,940 people, 3,644 attempted
profiles, 485 people with a verified affiliation, 207 people with a verified
employer, 3,597 archival-review assessments, 2,839 published claims, and 2,513
public sources. Download checks returned 23,941 personnel CSV lines, 23,940
personnel JSONL records, 492 organization CSV lines, 1,421 affiliation CSV
lines, and 2,514 source CSV lines.
...
## Batch 380 production deployment

Release `a3638bb980c144c5906606032cc5143d26f9abb3` passed GitHub test workflow
[33339554891](https://github.com/therealjameswilson/before-oss/actions/runs/33339554891)
and Pages workflow
[33339554865](https://github.com/therealjameswilson/before-oss/actions/runs/33339554865).
The clean runner repeated the Python suite, complete 24,434-page internal-link
check, 1,332-case browser and accessibility matrix, source-PDF reconstruction,
and private-identifier audit.

The production audit opened seven core routes and all ten Batch 380 person
profiles. All 17 returned HTTP 200. The live manifest and all 65 listed assets
matched the audited local release byte for byte, covering 81,441,815 bytes with
zero failures. The live manifest SHA-256 is
`b1cd1d7ea75267ba262711c240799af01dec3da054f808dc48e3f2598f9d08b7`.
The live statistics report 23,978 source rows, 23,940 people, 3,585 attempted
profiles, 478 people with a verified affiliation, 205 people with a verified
employer, and 3,538 archival-review assessments. Download checks returned
23,941 personnel CSV lines, 23,940 personnel JSONL records, 487 organization
CSV lines, 1,391 affiliation CSV lines, and 2,471 source CSV lines.
...
## Batch 375 local release check

The static build contains 24,432 HTML files, including direct pages for all
23,940 active person entities, 484 public organizations, and every Batch 375
profile. Every internal link resolves. The 65 public-manifest files cover
81,088,812 bytes and passed all 130 size and SHA-256 checks in each of the
public and built trees. The manifest SHA-256 is
...
substring coincidences and found zero unexpected boundary matches. A separate
scan of the Batch 375 evidence bundle also found zero full private identifiers.
The ten profiles publish only masked or explicitly unprinted identifiers and
preserve every unresolved or ambiguous identity.
...
## Batch 372 local release check

The static build contains 24,432 HTML files, including direct pages for all
23,940 active person entities, 484 public organizations, and every Batch 372
profile. Every internal link resolves. The 65 public-manifest files cover
80,935,348 bytes and passed all 130 source-tree and built-tree size and SHA-256
checks. The manifest SHA-256 is
`9d7f28bd4fa9cf09a14741b01dac1ea4723dcd78a73a10889f1e1c335a357cdd`.

The public identifier audit examined 12,926 normalized private identifiers,
120 formatted variants, and 24,502 production artifacts. It rejected 1,065
substring coincidences and found zero unexpected boundary matches. The ten
Batch 372 profiles preserve all seven unresolved identities and expose only
masked or explicitly unprinted identifiers.

All four Batch 371 official citation endpoints returned HTTP 200 during
targeted scripted verification: the NARA personnel-index PDF, public Army-
series Catalog page, and both official technical-documentation PDFs. No
access control was bypassed, no authenticated Catalog API request was made,
and no raw Catalog API response was stored.

## Batch 371 local release check

The static build contains 24,432 HTML files, including direct pages for all
23,940 active person entities, 484 public organizations, and every Batch 371
profile. Every internal link resolves. The 65 public-manifest files cover
80,887,510 bytes and passed all 130 source-tree and built-tree size and SHA-256
checks. The manifest SHA-256 is
`3f3e6b3d2cc7c5e6aafeed0f5e5501c985b54543f7ed031aaf2c4e437f378e8a`.

The public identifier audit examined 12,926 normalized private identifiers,
120 formatted variants, and 24,502 production artifacts. It rejected 1,068
substring coincidences and found zero unexpected boundary matches. The ten
Batch 371 profiles preserve all seven unresolved identities and expose only
masked or explicitly unprinted identifiers.

All four Batch 370 official citation endpoints returned HTTP 200 during
targeted scripted verification: the NARA personnel-index PDF, public Army-
series Catalog page, and both official technical-documentation PDFs. No
access control was bypassed, no authenticated Catalog API request was made,
and no raw Catalog API response was stored.

## Batch 370 local release check

The static build contains 24,432 HTML files, including direct pages for all
23,940 active person entities, 484 public organizations, and every Batch 370
profile. Every internal link resolves. The 65 public-manifest files cover
80,835,812 bytes and passed all 130 source-tree and built-tree size and SHA-256
checks. The manifest SHA-256 is
...
120 formatted variants, and 24,502 production artifacts. It rejected 1,067
substring coincidences and found zero unexpected boundary matches. The ten
Batch 370 profiles preserve all five unresolved identities and expose only
masked or explicitly unprinted identifiers.
...
targeted scripted verification: the NARA personnel-index PDF, public Army-
series Catalog page, both official technical-documentation PDFs, and the
preserved Department of State newsletter issue. The direct Hoover Institution
PDF returned HTTP 403 to the scripted client after its pages had been
...
The complete 24,432-page internal-link pass includes Edmond L. Caron through
George Carpenter on PDF page 70 in Box 108. It keeps Army-entry occupations
and student status outside employer counts, publishes Betty Carp's qualified
State Department-to-OSS chronology, leaves Edmond L. Caron's undefined code
uninterpreted, rejects Michael J. Carp's mismatched-identifier candidate, and
preserves five unsupported identities as critical archival-review profiles.
All 75 Python tests and five subtests, the deterministic 200-profile audit, the
complete 1,182 / 1,182 browser and accessibility matrix, all 27 axe cases,
dependency audit, database integrity checks, source checks, and public-
identifier audits pass; Astro reports zero errors, warnings, or hints.

All 65 manifest assets cover 80,666,237 bytes and match their recorded sizes
and SHA-256 hashes in both the source and built public trees. The manifest
SHA-256 is
...
## Batch 562 local link, manifest and redaction check

The static build contains 24,605 HTML files, including direct pages for all
23,940 active person entities and the ten Batch 562 profiles. Every internal
link resolves; 50,038 unique external URLs were inventoried for separate live
checking. The public-manifest guard verifies 67 assets and 94,857,400 bytes at
manifest SHA-256
`de23b5e113e0a93a52d9b6fb8f3eb37a560906d97dede852a6be3836a70b0929`.

The boundary-aware audit compares 12,926 normalized private identifiers and
...
The static build contains **24,694 HTML files**, including direct pages for all
**23,939 active person entities** and the 22 Batch 649 profiles. Every internal
link resolves; **50,278** unique external URLs were inventoried for separate
live checking. The public-manifest guard verified **67 assets** and
**99,139,369 bytes** at manifest SHA-256
