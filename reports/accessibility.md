...
accessibility checks with no serious or critical axe violations. All **135**
Python unit tests passed. Astro reported zero errors, warnings, or hints across
**290** source files and built **24,725** static pages. Every internal link
...
consecutive builds reproduced the same public and production tree digests.
These local results do not by themselves establish CI or public deployment.
...
accessibility checks with no serious or critical axe violations. All **133**
Python unit tests passed. Astro reported zero errors, warnings, or hints across
**284** source files and built **24,714** static pages. Every internal link
resolves, the public-identifier audit found zero unexpected full-number
matches, and two consecutive public-data builds reproduced the same tree
digests. These local results do not by themselves establish CI or public
deployment.

Batch 637 local validation, 2026-09-22 UTC: the isolated tracked-only bounded
release suite passed **84/84** desktop, phone, and tablet checks: 15 page-308
identity, conflict, duplicate-ambiguity, rejected-newspaper-candidate,
...
violations. All **132** Python unit tests passed. Astro reported zero errors,
warnings, or hints across **268** source files and built **24,681** static
pages. Every internal link resolves, the 200-profile stratified structural
audit passes all seven checks, and two consecutive builds reproduce the same
output-tree digest. The structural audit is not the required independent
manual historical audit of 200 profiles. These local results do not by
themselves establish CI or public deployment.

Batch 636 local validation, 2026-09-22 UTC: the isolated tracked-only bounded
release suite passed **84/84** desktop, phone, and tablet checks: 15 page-308
identity, conflict, duplicate-ambiguity, rejected-newspaper-candidate,
exact-coverage, and oil-category checks; 33 core-route checks; six analysis
checks; and 30 accessibility checks with no serious or critical axe
violations. All **132** Python unit tests passed. Astro reported zero errors,
warnings, or hints across **267** source files and built **24,681** static
pages. Every internal link resolves, the 200-profile stratified structural
audit passes all seven checks, and two consecutive builds reproduce the same
output-tree digest. The structural audit is not the required independent
manual historical audit of 200 profiles. These local results do not by
...
Batch 635 local validation, 2026-09-22 UTC: the isolated tracked-only bounded
release suite passed **84/84** desktop, phone, and tablet checks: 15 page-307
identity, conflict, duplicate-ambiguity, rejected-newspaper-candidate,
exact-coverage, and oil-category checks; 33 core-route checks; six analysis
checks; and 30 accessibility checks with no serious or critical axe
violations. All **132** Python unit tests passed. Astro reported zero errors,
warnings, or hints across **266** source files and built **24,681** static
pages. Every internal link resolves, the 200-profile stratified structural
audit passes all seven checks, and two consecutive builds reproduce the same
output-tree digest. The structural audit is not the required independent
manual historical audit of 200 profiles. These local results do not by
...
Batch 634 local validation, 2026-09-22 UTC: the isolated tracked-only bounded
release suite passed **84/84** desktop, phone, and tablet checks: 15 page-307
identity, conflict, duplicate-ambiguity, rejected-newspaper-candidate,
exact-coverage, and oil-category checks; 33 core-route checks; six analysis
checks; and 30 accessibility checks with no serious or critical axe
violations. All **132** Python unit tests passed. Astro reported zero errors,
warnings, or hints across **265** source files and built **24,681** static
pages. Every internal link resolves, the 200-profile stratified structural
audit passes all seven checks, and two consecutive builds reproduce the same
output-tree digest. The structural audit is not the required independent
manual historical audit of 200 profiles. These local results do not by
...
Batch 633 local validation, 2026-09-22 UTC: the isolated tracked-only bounded
release suite passed **84/84** desktop, phone, and tablet checks: 15 Army
identity, temporal-qualification, conflict/privacy, rejected-namesake,
exact-coverage, and oil-category checks; 33 core-route checks; six analysis
checks; and 30 accessibility checks with no serious or critical axe
violations. All **132** Python unit tests passed. Astro reported zero errors,
warnings, or hints across **264** source files and built **24,681** static
pages. Every internal link resolves, the 200-profile stratified structural
audit passes all seven checks, and two consecutive builds reproduce the same
output-tree digest. The structural audit is not the required independent
manual historical audit of 200 profiles. These local results do not by
...
Batch 632 local validation, 2026-09-22 UTC: the isolated tracked-only bounded
release suite passed **81/81** desktop, phone, and tablet checks: 12 Army
identity, source-variant, rejected-namesake, exact-coverage, and oil-category
checks; 33 core-route checks; six analysis checks; and 30 accessibility checks
with no serious or critical axe violations. All **132** Python unit tests
passed. Astro reported zero errors, warnings, or hints across **263** source
files and built **24,681** static pages. Every internal link resolves, the
200-profile stratified structural audit passes all seven checks, and two
consecutive builds reproduce the same output-tree digest. The structural audit
is not the required independent manual historical audit of 200 profiles. These
local results do not by themselves establish CI or public deployment.

Batch 631 local validation, 2026-09-22 UTC: the isolated tracked-only bounded
release suite passed **81/81** desktop, phone, and tablet checks: 12 Army
identity, suffix-variant, rejected-namesake, exact-coverage, and oil-category
checks; 33 core-route checks; six analysis checks; and 30 accessibility checks
with no serious or critical axe violations. All **132** Python unit tests
passed. Astro reported zero errors, warnings, or hints across **262** source
files and built **24,681** static pages. Every internal link resolves, the
200-profile stratified structural audit passes all seven checks, and two
consecutive builds reproduce the same output-tree digest. The structural audit
is not the required independent manual historical audit of 200 profiles. These
...
Batch 630 local validation, 2026-09-22 UTC: the isolated tracked-only bounded
release suite passed **84/84** desktop, phone, and tablet checks: 15 identity,
privacy-boundary, variant-cluster, exact-coverage, and oil-category checks; 33
core-route checks; six analysis checks; and 30 accessibility checks with no
serious or critical axe violations. All **132** Python unit tests passed. Astro
reported zero errors, warnings, or hints across **261** source files and built
**24,681** static pages. Every internal link resolves, the 200-profile
stratified structural audit passes all seven checks, and two consecutive builds
reproduce the same output-tree digest. The structural audit is not the required
...
six analysis checks; and 30 accessibility checks with no serious or critical
axe violations. All **126** Python unit tests passed. Astro reported zero
errors, warnings, or hints across **245** local source files and built
**24,699** local pages. An unrelated untracked duplicate Sources route adds 25
...
**244** source files, built **24,674** pages, and repeated the same deterministic
...
checks; six analysis checks; and 30 accessibility checks with no serious or
critical axe violations. All **126** Python unit tests passed. Astro reported
zero errors, warnings, or hints across **243** local source files and built
**24,695** local pages. An unrelated untracked duplicate Sources route adds 25
local-only pages and is excluded from the clean release. The 200-profile
stratified structural audit passed; it is not the required 200-profile manual
historical source audit. These local results do not establish CI or public
deployment.

Batch 610 local validation, 2026-09-21 UTC: the bounded release suite passed
**81/81** desktop, phone, and tablet checks: 12 new Nelson Glueck, separate
Glazier and Green/Greene, and oil-category checks; 33 core-route checks; six
...
warnings, or hints across **242** local source files and built **24,696** local
...
audit passed; it is not the required 200-profile manual historical source
audit. These local results do not establish CI or public deployment.
...
critical axe violations. All **126** Python unit tests passed, including
the monotonic classification-refresh test. Astro reported zero errors,
warnings, or hints across **239** local source files and built **24,694**
local pages. An unrelated untracked duplicate Sources route adds 25
local-only pages and is excluded from the clean release. The 200-profile
stratified structural audit passed; it is not a manual historical source
review. These local results do not establish CI or public deployment.

Batch 606 local validation, 2026-09-21 UTC: the bounded release suite
passed **75/75** desktop, phone, and tablet checks: six page-139/140
profile checks; 33 core-route and oil-category checks; six analysis checks;
and 30 accessibility checks with no serious or critical axe violations.
All **124** Python unit tests passed, including new truncated-response
retry/resume tests for the LoC adapter. Astro reported zero errors,
warnings, or hints across **238** local source files and built **24,693**
local pages. An unrelated untracked duplicate Sources route adds 25
local-only pages and is excluded from the clean release. The 200-profile
stratified **structural** audit passed; it does not substitute for manual
historical source review. These local checks do not establish CI or
public deployment.
...
oil-category checks, 33 core-route checks, six analysis checks, and 30
accessibility checks with no serious or critical axe violations. The new
checks keep Druckenmiller's Army predecessor separate from his unnamed
...
checks cover all sixteen direct profiles, their unresolved civilian-employer
sections, Martin Dickson's visibly medium-confidence Army pathway and
...
register in the tablet viewport. Splitting its 3,694 citations into 25 static
...
Direct Wallace Deuel person, COI and Chicago Daily News organization URLs, and
the unresolved Frank Desuta route passed at all three widths. PR and main Test
workflows and Pages deployment succeeded; the live verifier matched every
manifest asset and ten affected direct profiles at merge commit `ba2bad4`.
...
values; one exact identifier-and-name Army identity; deliberate non-
interpretation of occupation value `944`; nine unresolved profiles; and exact
preservation of the indexed `Emiliy` spelling. The bounded core suite passed
18/18 and the analysis suite passed 6/6 across the same viewports. The axe
route suite passed 27/27 in 1.6 minutes with no serious violations. The clean
...
reproduced the public and production trees byte for byte. PR Test run
34921536919, main Test run 34921981099 and Pages run 34921981119 passed; the
live verifier matched every manifest asset, core route and direct cohort
profile.
...
three accepted identifier-and-name Army identities; three qualified entry-time
occupation findings without employers; the separate Elizabeth Davey duplicate-
name profiles; Homer David Jr.'s qualified official OSS identity; David
Davidian's ambiguity; Abraham Davidson's visible identity conflict; and three
unresolved profiles. The bounded core suite passed 18/18 and the analysis
suite passed 6/6 across the same viewports. The axe route suite passed 27/27
...
public and production trees byte for byte. PR Test run 34902061949, main Test
run 34902691961 and Pages run 34902691962 passed; the live verifier matched
...
unassigned Army and newspaper candidates; four unresolved identities; Edward
M Damen's unaccepted later-career namesake; and the separate Arnold H Damen
...
employment relationships; Benjamin Cushing's two unordered prewar librarian
roles; Edward Cushing's concurrent qualified roles; and four ambiguous or
unresolved profiles with Box 161 guidance. Three initial test-only order or
wording assumptions were corrected without changing evidence or site behavior.
The bounded core suite passed 18/18 and the analysis suite passed 6/6 across
...
network navigation. No Batch 424 test failed. All seven affected legacy
scenarios then passed across desktop, phone and tablet, 21/21 in 22.7 seconds.
...
Independent GitHub Test `33963248213`, PR 180, Pages `33969269323` and pinned
live verification subsequently passed; see
...
1,890/1,890 across desktop, phone and tablet in 15.7 minutes with retries
disabled. Twenty-four final focused browser and accessibility checks pass
across desktop, phone and tablet in 15.3 seconds on consecutive deterministic
Pages-configuration builds. The first authoring run had twelve assertion
failures caused by test-string and absent-section assumptions; only the tests
were corrected, without changing evidence or site behavior. The production
build reports zero Astro errors, warnings or hints. Independent GitHub Test
`33955136725`, PR 177, Pages `33956876406` and pinned live verification
subsequently passed; see
`reports/release_batch_420.md`.

Batch 419: the complete 1,866-case local browser/accessibility matrix passed
1,866/1,866 across desktop, phone and tablet in 14.9 minutes with retries
disabled. Twenty-four final focused checks pass on the consecutive
deterministic Pages-configuration builds. The production build reports zero
Astro errors, warnings or hints. Independent GitHub Test `33952923818`, PR
176, Pages `33954698899` and pinned live verification subsequently passed;
see `reports/release_batch_419.md`.

Batch 418: the complete 1,842-case local browser/accessibility matrix passed
1,842/1,842 across desktop, phone and tablet in 15.5 minutes with retries
disabled. Twenty-one final focused checks pass on the consecutive
deterministic Pages-configuration builds. The production build reports zero
Astro errors, warnings or hints. Independent GitHub Test `33950674331`, PR
175, Pages `33952406605` and pinned live verification subsequently passed;
see `reports/release_batch_418.md`.

Batch 417: the complete 1,821-case local browser/accessibility matrix passed
1,821/1,821 across desktop, phone and tablet in 15.0 minutes with retries
disabled. Fifteen final focused checks pass on the consecutive deterministic
Pages-configuration builds. The production build reports zero Astro errors,
warnings or hints. Independent GitHub Test `33948513639`, PR 174, Pages
`33949846453` and pinned live verification subsequently passed; see
`reports/release_batch_417.md`.

Batch 416: the complete 1,806-case local browser/accessibility matrix passed
1,806/1,806 across desktop, phone and tablet in 16.3 minutes with retries
disabled. Twelve final focused checks pass on the consecutive deterministic
Pages-configuration builds. The production build reports zero Astro errors,
warnings or hints. Independent GitHub Test `33946810994`, PR 173, Pages
`33948257696` and pinned live verification subsequently passed; see
...
warnings or hints. Independent GitHub Test `33945027673`, PR 172, Pages
`33946452068` and pinned live verification subsequently passed; see
...
disabled. Twelve final focused checks pass on the repeated deterministic
build. The production build reports zero Astro errors, warnings or hints.
Independent GitHub Test `33943189306`, PR 171, Pages `33944865714` and pinned
live verification subsequently passed; see
`reports/release_batch_414.md`.

Batch 413: the complete 1,770-case local browser/accessibility matrix passed
1,770/1,770 across desktop, phone and tablet in 18.8 minutes with retries
disabled. Nine final focused checks pass on the repeated deterministic build.
...
The production build reports zero Astro errors, warnings or hints. Independent
GitHub Test `33939013769`, PR 169, Pages `33940662130` and pinned live
verification subsequently passed; see `reports/release_batch_412.md`.
...
server retained the earlier build. After the final deterministic rebuild, the
...
Astro errors, warnings or hints. Independent GitHub Test `33933349412` passed
all 1,743 cases in 33 minutes 25 seconds, PR 167 merged, Pages `33935159559`
succeeded, and pinned live verification passed; see
`reports/release_batch_410.md`.
...
represented as a clean first-run local pass. Independent GitHub Test
`33904265520` later passed 1,707/1,707 in 29.6 minutes; Pages and pinned live
verification succeeded. See `reports/release_batch_407.md`.
...
documented Vanderbilt employment from his earlier Harvard professorship;
publish only the qualified Army-entry occupations supported for Carl H.
Chadwick and Carl F. Chafin; present Gladwin W. Chaffin's pre-OSS 14th Armored
Division pathway as a military assignment rather than civilian employment;
and route six unsupported identities plus Carl T. Chadsey Jr. to archival
review without inventing employers. The focused Batch 390 regression
separately passed **18 / 18** on the final build.
...
Army-entry occupations; preserve one confirmed identity with an uninterpreted
occupation value; qualify one last civilian employer without calling it the
immediate pre-OSS affiliation; preserve five unresolved Box 111 identities;
and withhold one low-confidence namesake chronology from public facts and
analytics. The focused Batch 376 regression separately passed **18 / 18**
across the three viewports after two test-only wording expectations were aligned
with the correctly rendered public copy.
...
institutional pathways; keeps two exact-identifier Army-entry occupations out
of employer counts; exposes Kenneth Carlisle's and Edward Carlson's identifier
conflicts; preserves John Carlos's and George Carlson's unresolved same-name
candidates; masks every private identifier; and routes unresolved questions to
archival review. The focused regression passed **9 / 9**, all nine new cases
...
Army records while publishing only broad, date-bounded civilian occupation
categories; keeps both out of verified-employer analytics; preserves the
initial-only H. S. Campbell entry; avoids inferring service branch or
nationality from identifier formats; masks all identifiers; and routes eight
unresolved people to Box 103 review. The focused regression passed **3 / 3**,
and all 27 axe cases passed in the complete **1,047 / 1,047** matrix.
...
occupation without inventing an employer; confirms Joseph C. Bysarovich while
leaving an unassigned code uninterpreted; qualifies Stephen Byzek's postwar
identity without projecting a 1957 rank backward; qualifies George J. Cabaud
from a British SOE personnel-file pointer without inventing pre-OSS chronology;
masks private identifiers; and routes six unsupported identities to Box 99 or
100 review. The focused regression passed **3 / 3** across desktop, phone, and
tablet.
...
E. Butke from exact private-identifier Army records while keeping broad entry
occupations separate from employers; separates Buta's Miami University student
status from his military pathway; qualifies Wilsie Bussell's Elon College
employment and Marillyn Butcher's University of Minnesota student evidence;
keeps Inez Bushner's institutional biography in the identity-review lane;
masks private identifiers; and routes the remaining unsupported identities to
Box 97 review. The focused regression passed **3 / 3** across desktop, phone,
and tablet.

Batch 333 adds a focused direct-route regression for Billie V. Bush through
Davis Bushnell on PDF page 63. It confirms Vernon A. Bush's exact-identifier
Army entry and qualified baker occupation without turning the occupation into
an employer; preserves Asa Bushnell's father-and-son namesake ambiguity while
withholding the low-confidence candidate claim; retains Billie's printed
lieutenant and George's printed private classifications; masks private
identifiers; and routes the remaining unsupported profiles to Box 96 or 97
review. The focused regression passed **3 / 3** across desktop, phone, and
tablet.
...
Batch 328 adds a focused direct-route regression for Albert V. Burns through
both adjacent Marian H. Burns rows on PDF page 62. It verifies that Frank G.
Burns's identifier disagreement appears as a conflict without publishing the
unrelated Army subject; both Marian rows remain separate ambiguous profiles in
one possible-duplicate group; eight unsupported identities retain dignified
Box 95 archival-review pages; and only masked identifier suffixes appear. An
initial test-only suffix typo was corrected to the visually checked value; the
focused regression then passed **3 / 3** across desktop, phone, and tablet.
...
occupation fields remain separate from employers; Big Sandy High School is
rendered as student evidence; Charles S. Burdell's Justice Department role is a
documented prewar government assignment rather than an immediate affiliation;
public organization links resolve under the Pages base path; and unsupported
identities retain dignified archival-review pages. The focused regression
passed **3 / 3** across desktop, phone, and tablet.
...
matches while publishing only Francis J. Bucolo's dated sales-clerk occupation
and Anthony J. Budraitis's dated meatcutter occupation; preserves Bernard J.
Budenosky's zero occupation field without inventing work; keeps three printed
officer grades in the commissioned filter without assigning namesake
biographies; and routes seven unsupported Box 90-91 identities to archival
review. The focused regression passed **3 / 3** across desktop, phone, and
tablet, and the expanded **942 / 942** browser and accessibility matrix passed
locally.
...
matches while keeping broad manufacturing occupations out of employer
analytics; exposes Edgar J. Buck's identifier conflict without publishing the
unrelated person's name or data; publishes Buckens's documented Belgian
Embassy interpreter assignment without labeling it immediate or a civilian
employer; and preserves six unresolved Box 90 profiles. The focused regression
passed **3 / 3** across desktop, phone, and tablet, and the expanded
**936 / 936** browser and accessibility matrix passed locally.
...
Army-entry identity while publishing only the broad foundry-occupations group;
keeps Larry Bruzzese's specialist-history military match visibly probable and
out of employer analytics; rejects an unsupported Robbie L. Bruton student
namesake; and preserves the other eight profiles on the Box 89 archival-review
path. The focused regression passed **3 / 3** across desktop, phone, and tablet,
and the expanded **930 / 930** browser and accessibility matrix passed locally.
...
normalized identifier-backed Army identities, publishes three qualified pre-
entry occupation categories without converting them into named employers,
keeps two adjacent John D. Brown rows separate in one duplicate-review group,
and preserves six underdetermined identities as archival-review profiles. The
...
serious or critical axe violation. The complete **870-case** browser matrix
runs in release CI.
...
named employers; preserves eight underdetermined identities as archival-review
profiles; and keeps the Gwyneth King Brown artist namesake unassigned. The
focused regression passed **3 / 3** across desktop, phone, and tablet. A fresh
core-route axe matrix passed **27 / 27**, including the Sources table, with no
serious or critical axe violation. The complete **864-case** browser matrix runs
in release CI.
...
residual professional category, Nelson S. Brooks's unnamed student status, and
Norman Brooks's grouped aircraft-building occupation distinct from named
employers; confirms Levis C. Brooks's commissioned classification without
inventing a predecessor; and preserves Ida E. Brooks as an unresolved profile
without organization links. The focused regression passed **3 / 3** across
desktop, phone, and tablet. A fresh core-route axe matrix passed **27 / 27**,
including the Sources table, with no serious or critical axe violation.
...
public-safe identifier rendering, personnel classifications, terminal research
states, confidence qualification, and employer-gap language. It verifies that
Richard M. Bownass remains a probable identity whose Tangier assignment is
withheld from public affiliation sections; that John H. Boxer's probable
profile separates Vienna student status from qualified work at an unnamed
Texas architectural office; and that the other eight profiles remain
unresolved archival-review cases. The focused regression passed 3 / 3. The
complete browser and axe run produced 809 passing cases and one tablet timeout
on the older `/sources/` regression. That single case passed in an isolated
retry, producing 810 / 810 passing assertions overall with no serious or
...
research states, confidence qualification, and employer-gap language. It
verifies five exact-identifier Army identities and their five qualified,
date-bounded civilian occupations without presenting any occupation as a named
employer; preserves Ernest J. Bouchea's late-record and rank conflict; and keeps
four unsupported or misspelled-name candidates unresolved. The focused
regression passed 3 / 3, and the complete matrix passed 792 / 792 locally in
24.6 minutes with no serious or critical axe violation.
...
67, public-safe identifier masking, identity and research states, and employer-
gap language. It separately verifies three exact-identifier Army-entry
occupations without converting them into employers; George N. Boncescu's
qualified, documented-prewar Romanian Legation affiliation; Joan V.
...
ranks or civilian grades, Box 61, public-safe identifier masking, identity and
research states, and terminal employer-gap language. It separately verifies
four exact Army-record identity matches; William G. Bliden's qualified Fort
Devens assignment; Emory F. Blincoe's qualified Strayer student affiliation;
...
literal ranks or blank-rank states, Boxes 59-60, public-safe identifier
masking, identity and research states, employer-gap wording, and archival-
review routes. It separately verifies three qualified Army-entry occupation
groups, the Blackenship/Blankenship spelling resolution, Jasper's post-OSS
date boundary, and Robert L. Blackman's documented electronic-file gap without
turning any of them into an employer claim. Six unsupported identities remain
explicit archival-review cases. The focused local matrix passed 3 / 3, and the
complete 693 / 693 matrix passed in
[workflow 31245990693](https://github.com/therealjameswilson/before-oss/actions/runs/31245990693).
...
ranks or civilian grades, Box 58, public-safe identifier masking, identity and
research states, employer-gap wording, and archival-review routes. It
separately verifies three qualified occupation findings, the Stephen/Steven
Bizic variant, Romeo Bizaillon's identity-only post-OSS record, and KSTP as
Kristjan Bjornson's last civilian employer before Navy service without
promoting it to an immediate pre-OSS affiliation. Five unsupported identities
remain explicit archival-review cases. The focused matrix passed 3 / 3.
...
ranks, Boxes 56-57, public-safe identifier masking, identity and research
states, employer-gap wording, and archival-review routes. It separately
verifies Bilsky's and Bindi's bounded Army-entry evidence, Bimler's visible
identifier conflict, Binet's Free French intelligence pathway, the
Woodridge/Woodbridge Bingham spelling resolution and Berkeley employment,
Binninger's qualified OSS identity, and Binson's documented teaching and
student affiliations. The focused matrix passed 3 / 3.

Batch 209 adds a focused direct-route regression for Clarence P. Bilderback
through Ferdinand Bilotta on PDF page 37. It checks all ten indexed names,
literal ranks, Box 56, public-safe identifier masking, identity and research
states, employer-gap wording, and archival-review routes. It separately
verifies four qualified Army-entry occupations, Donald Jay Billman's high-
confidence identity, Adrien W. Bilodeau's confirmed identity, Charley A.
Billiot's visible official-source conflict, and the unassigned Robert H.
Bilodeau candidate. The focused matrix passed 3 / 3.
...
civilian grade, Box 53 location, masked or explicitly unprinted identifier,
research state, employer-gap wording, and archival-review route. It separately
verifies Dan P. Berry's, Edward S. Berry's, and Patrick J. Berry, Jr.'s qualified
Army-entry occupation categories without inventing named schools, financial
institutions, offices, or employers; Harold A. Berry's commissioned-officer
classification; and seven unresolved profiles. The focused matrix passed 3 / 3.
...
civilian grade, Box 52 location, masked identifier, research state, employer-
gap wording, and archival-review route. It separately verifies the Army-entry
occupation-only evidence, Irving Bernstein's typed institutional roles, Nahum
A. Bernstein's corroborated identity without a named firm, Peter L.
Bernstein's qualified last civilian employer, and Philip M. Bernstein's
student status without inventing a school. Five other profiles remain
unresolved. The focused matrix passed 3 / 3.
...
Box 51 location, masked or explicitly unprinted identifier, identity and
research-state badges, and archival-review status. It separately verifies
Milton A. Berger's high-confidence New York private law practice as last
civilian self-employment without presenting it as the immediate pre-OSS
affiliation; keeps Tharrel A. Bergeson's qualified school evidence as student
status; preserves four official occupation-only findings without inventing
employers; and leaves four unresolved profiles explicit. The focused matrix
passed 3 / 3.
...
Batch 185 adds a focused direct-route regression for the ten source rows from
Carl H. Bengt through Sylvia S. Bennet. The desktop case passed locally, as did
all 27 dedicated axe cases across desktop, phone, and tablet. It verifies all
ten Box 49 rows, the two separate John R. Bennet profiles and their public-safe
...
Belanger's previously reviewed pathway. It verifies all ten source rows, Box 47
routing, literal printed ranks and grades, and masked or unprinted identifiers.
Konrad Bekker's one-digit Army-identifier conflict remains visible; Salvatore
Belcastro's conversion-gap candidate remains below publication threshold;
George N. Belic's Navy service remains temporally qualified; and Ferdinand
Belin's National Gallery governance role remains distinct from employment.
Five unresolved profiles retain explicit archival-review guidance. The
production build contains 24,269 static pages.
...
Box 46 routing, literal printed ranks and grades, and masked or unprinted
identifiers. David Bedor's and George E. Beeman's official Army-entry evidence
supports occupation-only findings, not named employers; Henry W. Beecher Jr.'s
official-source identifier conflict remains visible without publishing either
full identifier; and Madison S. Beeler's Harvard and Berkeley teaching path is
qualified by its documented chronology. Edmund Bednarek, Carlos A. Beebe,
Robert P. Beebe, Gertrude C. Beecher, Willard E. Beecher, and Leslie L. Beeler
Jr. retain explicit unresolved and archival-review guidance. The production
build contains 24,266 static pages.
...
page locators, and masked or unprinted identifiers. Calvin L. Beale's
high-confidence identity and qualified Veterans Administration pathway remain
visible with the `probable_immediate` temporal basis and do not inflate the
verified metrics. Elizabeth Beall preserves `P-1` in the printed middle-initial
column, keeps the rank unprinted, and remains indeterminate. Nine unresolved
profiles retain explicit no-result and archival-review language.
...
unprinted identifiers. Three official Army enlistment occupation findings
remain explicitly distinct from employers; Evan A. Baugh's Utah State
Agricultural College relationship and Warren C. Baum's Columbia University
relationship remain student status; Baugh's Army pathway remains a military
assignment; Jean P. Baugier's probable French-officer match stays qualified;
and all unresolved profiles retain explicit no-result and archival-review
language.
Batch 161 adds direct desktop, phone, and tablet checks for Johnnie Batten
through Frederick A. Bauer across the page-twenty-six/page-twenty-seven
boundary. It verifies all ten source rows, Box 42 routing, printed ranks or
civilian grades, page locators, and masked identifier display. Five official
Army enlistment occupation findings remain explicitly distinct from employers;
the Marion/Mario Battipede source variance remains visible; Ann Battie's
high-confidence identity exposes its Washington Post citation without turning
undated education into a pre-OSS affiliation; and the four unresolved profiles
retain explicit no-result and archival-review language.
...
identifier display. Bastedo's probable-immediate Lend-Lease assignment remains
distinct from his unnamed New York law-firm employment and earlier federal
assignments. Batcheler's confirmed occupation evidence does not become an
employer. Chandler Bates Jr.'s Princeton student status remains a
non-employment affiliation. The other seven profiles retain explicit
archival-review guidance, and all five linked organization routes lead back to
...
grades and military ranks, page locators, and masked identifier display. Lewis
Barrington's high-confidence profile separately presents the United States
Army as his immediate military assignment and the Federal Writers' Project as
his last civilian employer, with the first-lieutenant and research-editor roles
and claim-level Phi Kappa Psi and Library of Congress citations. The Federal
Writers' Project organization route links back to Barrington. The other nine
profiles retain explicit no-result language and archival-review guidance; the
withheld Dayton Barrows burial lead is not promoted into public identity or
employment evidence.
Batch 151 adds direct desktop, phone, and tablet checks for Jean M. Barrett
through Robert F. Barrick on page twenty-four. It verifies all ten source rows,
Box 39 routing, preserved civilian grades and military ranks, and masked
identifier display. Raymond J. Barriault's profile publishes only the qualified
high-confidence OSS identity and leaves the employer fields unresolved. Robert
F. Barrick's profile presents Camp Ritchie as an earlier documented military
assignment, not an immediate affiliation or civilian employer, with official
and institutional citations. The other eight profiles retain explicit no-
result language and archival-review guidance without namesake fact transfer.
...
field-level serial masking. Eight profiles remain unresolved with explicit
no-result language and archival-review guidance. Warren L. Barnette Jr.'s
high-confidence profile publishes the U.S. Army as his immediate military
assignment while keeping three jobs documented no later than 1936 in the
earlier-employment section and leaving his last civilian employer unresolved.
Edward N. Barnhart's high-confidence profile separately presents the Office of
...
repeated the complete 483 / 483 matrix successfully for Batch 146 release
`bece86d`; Pages workflow
[30739392833](https://github.com/therealjameswilson/before-oss/actions/runs/30739392833)
also completed successfully. An independent live check verified the seven core
routes and ten Batch 146 profiles at HTTP 200 with the intended content.
...
and field-level serial masking. It also verifies Harold Barger's qualified
Columbia University employment and assistant-professor role, keeps the
immediate affiliation unresolved, exposes the indexed/wartime rank variation,
and preserves nine visibly unresolved identities with archival-review
guidance.
