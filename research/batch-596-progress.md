...
Reviewed 2026-09-20 UTC. All 46 printed rows on page 124 of the original [NARA OSS personnel index](https://www.archives.gov/files/iwg/declassified-records/rg-226-oss/personnel-database.pdf) were compared with the stored extraction and matched without correction. This includes two separate Millard P Downey rows, the Fred B Drake `also AS` note, Rene Drap's `French` note and S/Lt rank, and the Box 197–199 transitions. The decision is replayable from `research/parser_visual_review_page124_2026-09-20.json`. This is the 100th visually reviewed page; the extraction validation still passes all 522 page-coverage and low-confidence-row gates.
